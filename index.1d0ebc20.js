 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Er=new yt(3e4,6e4);function Ir(){const e=$n().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Sr=null;function Tr(e){return Sr=Sr||function(e){return new Promise(((t,n)=>{var r,i,o;function s(){Ir(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Ir(),n(st(e,"network-request-failed"))},timeout:Er.get()})}if(null===(i=null===(r=$n().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=$n().gapi)||void 0===o?void 0:o.load)){const t=Xn("iframefcb");return $n()[t]=()=>{gapi.load?s():n(st(e,"network-request-failed"))},Yn(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw Sr=null,e}))}(e),Sr}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
function Mr(e=$e()){const t=je(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=je(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(K(n.getOptions(),null!=t?t:{}))return e;ot(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:xr,persistence:[Qn,Dn,Bn]})}Ur="Browser",Be(new ie("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),{apiKey:i,authDomain:o}=n.options;return((e,n)=>{ct(i&&!i.includes(":"),"invalid-api-key",{appName:e.name}),ct(!(null==o?void 0:o.includes(":")),"argument-error",{appName:e.name});const r={apiKey:i,authDomain:o,clientPlatform:Ur,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:tn(Ur)},s=new rn(e,n,r);return function(e,t){const n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(dt);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(s,t),s})(n,r)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Be(new ie("auth-internal",(e=>{const t=on(e.getProvider("auth").getImmediate());return new Dr(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),ze("@firebase/auth","0.20.5",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Ur)),ze("@firebase/auth","0.20.5","esm2017");(bo=o("kEUo3")).pad;const Br={formSignIn:document.querySelector("#form-sign-in"),formSignUp:document.querySelector("#form-sign-up")};let jr={};function Fr(e){jr[e.target.name]=e.target.value,localStorage.setItem("register-form-state",JSON.stringify(jr))}Br.formSignIn.addEventListener("submit",(async function(e){e.preventDefault();const{email:{value:t},password:{value:n}}=e.target;if(!t||!n)return $r("noValidForm");Nn(qr,t,n).then((e=>{const t=e.user;Xr.currentUser=t,Xr.authSuccess(t),Vr(),$r("signInSuccess",t)})).catch((e=>{$r("signInFaild",e)}))})),Br.formSignUp.addEventListener("submit",(async function(e){e.preventDefault();const{email:{value:t},password:{value:n},agreement:{checked:r}}=e.target;if(!t||!n||!r)return $r("noValidForm");Cn(qr,t,n).then((e=>{const t=e.user;Xr.currentUser=t,$r("registerSuccess",t),function(e){for(const t in e)delete e[t];localStorage.removeItem("register-form-state")}(jr),Xr.authSuccess(t),Kr(),Jr()})).catch((e=>{$r("registerFaild",e)})),e.currentTarget.reset()})),Br.formSignIn.addEventListener("input",Fr),Br.formSignUp.addEventListener("input",Fr),window.addEventListener("load",(function(){jr=JSON.parse(localStorage.getItem("register-form-state")),jr?function(e){for(const t in e)Br.formSignIn[t].value=e[t]}(jr):jr={}})),window.addEventListener("load",(function(){jr=JSON.parse(localStorage.getItem("register-form-state")),jr?function(e){for(const t in e)Br.formSignUp[t].value=e[t]}(jr):jr={}}));!function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),r=n.name;if("string"!=typeof r||!r)throw Fe.create("bad-app-name",{appName:String(r)});const i=Ue.get(r);if(i){if(K(e,i.options)&&K(n,i.config))return i;throw Fe.create("duplicate-app",{appName:r})}const o=new se(r);for(const e of De.values())o.addComponent(e);const s=new qe(e,n,o);Ue.set(r,s)}({apiKey:"AIzaSyCFrUsAa2GnJsQSsnbY7n2RsUa4nEwcnLw",authDomain:"test-accaunts.firebaseapp.com",databaseURL:"https://test-accaunts-default-rtdb.firebaseio.com",projectId:"test-accaunts",storageBucket:"test-accaunts.appspot.com",messagingSenderId:"438814438695",appId:"1:438814438695:web:19b67e8971090cb7cda502"});const qr=Mr();function $r(e,t){switch(e){case"registerSuccess":alert(`${t.email} register was success and you have been sign in`);break;case"registerFaild":case"signInFaild":alert(`${t.message}`);break;case"signInSuccess":alert(`${t.email} you have been sign in`);break;case"noValidForm":alert("Please, fill all form fields");break;case"logOut":alert(`${t} was loged out`)}}const zr={};var Hr=zr;document.querySelectorAll("[data-id]").forEach((e=>{zr[e.dataset.id]=e}));const Wr={formSignIn:document.querySelector("#form-sign-in"),formSignUp:document.querySelector("#form-sign-up"),modalWrapperSignIn:document.querySelector("[data-modal-sign-in]"),modalWrapperSignUp:document.querySelector("[data-modal-sign-up]"),modalGreetings:document.querySelector("[data-modal-greetings]"),buttonAuth:document.querySelector("#btn-auth"),buttonClose:null,inputCheck:document.querySelector("#agreement"),buttonChangeModal:null,buttonCloseGreetings:null};function Vr(){document.querySelector('[data-id = "auth"]');Wr.modalWrapperSignIn.classList.toggle("is-hidden")}function Gr(){Pn(Mr()).then((()=>{document.querySelector(".enter-btn").innerHTML="<p>Check in</p>",$r("logOut",Hr.placeForName.innerText),Hr.placeForName.innerHTML="",Wr.buttonCloseSignIn.addEventListener("click",Vr),Wr.buttonCloseSignIn.removeEventListener("click",Gr),Xr.currentUser=null})).catch((e=>{console.log(e)}))}function Jr(){const e=Wr.modalWrapperSignUp;e.classList.contains("is-hidden")?(e.classList.remove("is-hidden"),window.addEventListener("keydown",Yr)):(e.classList.add("is-hidden"),window.removeEventListener("keydown",Yr))}function Kr(){Wr.modalGreetings.classList.toggle("is-hidden")}function Qr(){Jr(),Vr()}function Yr(e){if("Escape"!==e.code)return;let t=Wr.modalWrapperSignUp;t.classList.contains("is-hidden")||(console.log("SignUp"),Jr()),t=Wr.modalWrapperSignIn,t.classList.contains("is-hidden")||(console.log("SignIn"),Vr())}Wr.buttonCloseSignIn=document.querySelector("[data-modal-close-sign-in]"),Wr.buttonCloseSignIn.addEventListener("click",Vr),Wr.buttonCloseSignUp=document.querySelector("[data-modal-close-sign-up]"),Wr.buttonCloseSignUp.addEventListener("click",Jr),Wr.buttonChangeToSignIn=document.getElementById("btn-open-sign-in"),Wr.buttonChangeToSignIn.addEventListener("click",Qr),Wr.buttonChangeToSignUp=document.getElementById("btn-open-register"),Wr.buttonChangeToSignUp.addEventListener("click",Qr),Wr.buttonCloseGreetings=document.querySelector("[data-modal-close-greetings]"),Wr.buttonCloseGreetings.addEventListener("click",Kr);class Xr{static init(){this.button=document.querySelector('[data-id = "auth"]'),this.libraryContent=document.querySelector(".movies-card"),this.menuAuth=document.querySelector(".enter-btn"),this.button.addEventListener("click",Vr)}static authSuccess({email:e}){Hr.placeForName.innerHTML=`<p>${e.split("@")[0]}</p>`,this.menuAuth.innerHTML="<p>LOG OUT</p>",this.button.removeEventListener("click",Vr),this.button.addEventListener("click",Gr)}constructor(){n(D)(this,"button",null),n(D)(this,"menuAuth",null),n(D)(this,"libraryContent",null),n(D)(this,"currentUser",null)}}Xr.init();const Zr=new class{async getOneMovie(e){if(this.message="OK!",!e)return void(this.message="There is no search query");const t="movie/"+ +e,n=new URLSearchParams({append_to_response:"videos"});return this.getMovies(t,n)}async getSearchQuery(e,t){return e?await this.getMoviesByTitle(e,t):await this.getPopularMovies(t)}async getMoviesByTitle(e,t){if(this.message="OK!",!e)return void(this.message="Empty request");if(t<1)return void(this.message="Small value page");if(this.query&&t>this.totalPage)return void(this.message="Great value page");const n=new URLSearchParams({page:t||1,query:e}),r=await this.getMovies("search/movie",n);return r?(this.query=e,r):void 0}async getPopularMovies(e){return await this.SearchMoviesByCategory("trending/movie/week",e)}async getTopRated(e){return await this.SearchMoviesByCategory("movie/top_rated",e)}async getUpcoming(e){return await this.SearchMoviesByCategory("movie/upcoming",e)}async SearchMoviesByCategory(e,t){if(this.message="OK!",t<1)return void(this.message="Small value page");if(1!==this.totalPage&&t>this.totalPage)return void(this.message='Great value "page"');const n=new URLSearchParams({page:t||1});return await this.getMovies(e,n)}createUrl(e,t){const n=t||"";return"https://api.themoviedb.org/3/"+e+"?"+new URLSearchParams({api_key:"833791a5e754a1f0443be5fc62646bdb",include_adult:!1,language:this.langauge})+"&"+n}async fetchMovies(e){try{return await fetch(e).then((e=>{if(!e.ok)throw new Error(e.status);return e.json()}))}catch(e){return void(this.message=e.message)}}async getMovies(e,t){const n=this.createUrl(e,t),r=await this.fetchMovies(n);return"movie/"===e.slice(0,6)?r||void(this.message="No information found"):r&&0!==r.results.length?(this.data=r,this.page=r.page,this.totalPage=r.total_pages,r):void(this.message="No information found")}async getGenres(){const e=this.createUrl("genre/movie/list"),{genres:t}=await this.fetchMovies(e);return t}async galleryData(){this.genres=await this.getGenres()}constructor(){this.page=1,this.totalPage=1,this.data={},this.query="",this.message="",this.genres=this.galleryData(),this.langauge="en-US"}};function ei(e){if(!e||0===e.length)return"No genre";const t="Other";let n=0,r="";for(;n<e.length;){const{name:i}=Zr.genres.find((t=>{if(t.id===+e[n])return t}));if(n+=1,r){if(r.length+i.length>=24-(t.length+2)){r+=", Other";break}r+=", "+i}else r+=i}return r}function ti(e){const{id:t,title:n,poster_path:r,release_date:i,vote_average:o,genre_ids:s}=e,a=Number(o).toFixed(1),u=(null==i?void 0:i.slice(0,4))||"";return`<li class="movies-card__item" data-card-id="${t}">\n            <div class="movies-card__thumb">\n              <img\n              \n                src="https://image.tmdb.org/t/p/w500/${r}"\n                onError="this.onerror=null;this.src='https://subscribenow.com.au/time/asia/Solo/Content/Images/noCover.gif';"\n                alt="${n}"\n                loading="lazy"\n              />\n            </div>\n            <div class="movies-card__content">\n              <h2 class="movies-card__heading">${n}</h2>\n              <p class="movies-card__text">\n                ${ei(s)} | ${u}\n                <span class="movies-card__rating">${a}</span>\n              </p>\n            </div>\n          </li>`}var ni;ni=new URL(o("kyEFX").resolve("8OQ7p"),import.meta.url).toString();const ri=document.querySelector(".icon-list"),ii=(document.querySelector(".search-form"),[...ri.children]),oi={on:function(){ii.forEach((e=>{e.classList.remove("is-hidden"),e.classList.add("animate__zoomIn");let t=e.children[0];t.classList.add("animate__flash"),t.classList.add("animate__delay-5s")}));for(let e=0;e<ii.length;e++)ii[e].classList.add(`animate__delay-${e}s`)},off:function(){ri.classList.contains("blockSreen")&&ri.classList.remove("blockSreen"),ii.forEach((e=>{e.classList.add("is-hidden"),e.classList.remove("animate__zoomIn");let t=e.children[0];t.classList.remove("animate__flash"),t.classList.remove("animate__delay-5s")}));for(let e=0;e<ii.length;e++)ii[e].classList.remove(`animate__delay-${e}s`)}};function si(){const e=`<div class="rectangle animate__fadeOutLeft">\n        <div class="notification-text">\n        <svg class="notification-icon">\n        <use href="${n(ni)}#icon-info"></use>\n        </svg>\n        <span> Please enter more than 2 characters </span>\n        </div>\n        </div>`;Hr.notifix.innerHTML=e}function ai(){const e=`<div class="rectangle animate__fadeOutLeft">\n        <div class="notification-text">\n        <svg class="notification-icon">\n        <use href="${n(ni)}#icon-rupor"></use>\n        </svg>\n        <span> Please enter a correction request </span>\n        </div>\n        </div>`;Hr.notifix.innerHTML=e}function ui(e){const t=e.map(ti).join("");Hr.moviesCard.innerHTML=t}const ci=document.querySelector(".movies-filter__list");ci.addEventListener("click",(async function(e){let t;if(Zr.page=1,"popular"===e.target.dataset.id&&"BUTTON"===e.target.nodeName){if(t=await Zr.getPopularMovies(Zr.page),Zr.totalPage=t.total_pages,li.classList.add("movies-filter__button--current"),hi.classList.remove("movies-filter__button--current"),fi.classList.remove("movies-filter__button--current"),1===t.total_pages)return void(Wi.innerHTML="");ui(t.results)}if("future"===e.target.dataset.id&&"BUTTON"===e.target.nodeName){if(t=await Zr.getUpcoming(Zr.page),Zr.totalPage=t.total_pages,hi.classList.add("movies-filter__button--current"),li.classList.remove("movies-filter__button--current"),fi.classList.remove("movies-filter__button--current"),1===t.total_pages)return void(Wi.innerHTML="");ui(t.results)}if("rating"===e.target.dataset.id&&"BUTTON"===e.target.nodeName){if(t=await Zr.getTopRated(Zr.page),Zr.totalPage=t.total_pages,fi.classList.add("movies-filter__button--current"),li.classList.remove("movies-filter__button--current"),hi.classList.remove("movies-filter__button--current"),1===t.total_pages)return void(Wi.innerHTML="");ui(t.results)}Gi(Zr.totalPage,Zr.page)}));const li=document.querySelector('[data-id="popular"]'),fi=document.querySelector('[data-id="rating"]'),hi=document.querySelector('[data-id="future"]');function di(){ci.classList.remove("visually-hidden")}function pi(e){e.preventDefault(),li.classList.remove("movies-filter__button--current"),fi.classList.remove("movies-filter__button--current"),hi.classList.remove("movies-filter__button--current");const t=e.currentTarget.elements.query.value.trim();t.length<=2||0===t.length?si():(oi.on(),ri.classList.add("blockSreen"),Ki(),async function(e){const t=Zr.totalPage,n=await Zr.getSearchQuery(e,1);if(!n)return Ki(),oi.off(),Hr.searchForm.reset(),void ai();const r=n.results.map((e=>ti(e))).join("");Hr.moviesCard.innerHTML=r,oi.off(),t>=2&&Gi(Zr.totalPage,Zr.page)}(t),Hr.moviesCard.innerHTML="")}Hr.searchForm=document.querySelector(".search-form");const gi=document.querySelector(".js-active-header"),vi=document.querySelector(".logo__name"),mi=document.querySelector(".background__main");let yi,_i,bi="homePage";function wi(){Qi()}function Ei(){bi="homePage",Hr.home.classList.add("side-nav__link--current"),Hr.library.classList.remove("side-nav__link--current"),Hr.header.classList.remove("header-bg-lib"),Hr.logoLink.setAttribute("style","cursor:default"),vi.classList.add("reveal-text"),vi.classList.remove("rise-text"),mi.classList.remove("background__main--lib")}function Ii(){gi.innerHTML=`<form class="search-form" data-id="searchForm">\n            <input\n              type="text"\n              name="query"\n              autocomplete="off"\n              data-id="searchQuery"\n              placeholder="Movie search"\n              class="search-field"\n            />\n            <button type="submit" class="search-btn" data-id="searchBtn">\n              <svg class="search-icon" width="12" height="12">\n                <use href="${ni}#icon-search"></use>\n              </svg>\n            </button>\n          </form>`}Ii(),Hr.home.classList.add("side-nav__link--current"),Hr.logoLink.setAttribute("style","cursor:default"),vi.classList.add("reveal-text"),mi.classList.remove("background__main--lib"),Hr.searchForm=document.querySelector(".search-form"),Hr.searchForm.addEventListener("submit",pi),Hr.home.addEventListener("click",(e=>{e.preventDefault(),Ki(),di(),"homePage"!==bi&&(Ei(),Ii(),Hr.searchForm=document.querySelector(".search-form"),Hr.searchForm.addEventListener("submit",pi),wi())})),Hr.library.addEventListener("click",(e=>{e.preventDefault(),Ki(),ci.classList.add("visually-hidden"),"libraryPage"!==bi&&(bi="libraryPage",Hr.library.classList.add("side-nav__link--current"),Hr.home.classList.remove("side-nav__link--current"),Hr.header.classList.add("header-bg-lib"),Hr.logoLink.setAttribute("style","cursor:pointer;"),vi.classList.remove("reveal-text"),vi.classList.add("rise-text"),mi.classList.add("background__main--lib"),gi.innerHTML='<div class="buttons-wrapper"><button\n            type="button"\n            class="library__buttons"\n            data-id="watchedBtn"\n          >\n            Watched\n          </button>\n          <button type="button" class="library__buttons" data-id="queueBtn">\n            Queue\n          </button></div>',yi=document.querySelector('[data-id="watchedBtn"]'),_i=document.querySelector('[data-id="queueBtn"]'),yi.addEventListener("click",ki),_i.addEventListener("click",Oi),Ti())})),Hr.logoLink.addEventListener("click",(e=>{e.preventDefault(),di(),"libraryPage"===bi&&(Ei(),Ii(),wi())}));let Si="Watched";function Ti(){"Watched"===Si&&yi.dispatchEvent(new Event("click")),"Queue"===Si&&_i.dispatchEvent(new Event("click"))}function ki(){yi.classList.add("library__button--active"),_i.classList.remove("library__button--active"),Si="Watched",xi(Di.watchedFilm)}function Oi(){_i.classList.add("library__button--active"),yi.classList.remove("library__button--active"),Si="Queue",xi(Di.filmInQueue)}function Ai(){const e=document.querySelector(".side-nav__link--current").dataset.id;if("home"!==e&&"library"===e){document.querySelector(".library__button--active").dataset.id;const e=Hr.paginationList.querySelector(".pagination__button--current");if(!e)return Ti();Ji({target:e})}}let Ri,Li,Ci,Ni;function Pi(e){return 0===e.length&&(Ki(),document.querySelector(".movies-card").innerHTML=`<div class="content__wrapper">\n        <h2 class="content__title">There's nothing here! <br/>\n          Please add some movies to\n          <span class="content__text">${Si}</span>!\n        </h2>\n      </div>`,!0)}function xi(e){const t=JSON.parse(localStorage.getItem(e))||[];if(Pi(t))return void Ki();Ri=Math.ceil(t.length/20);const n=function(e,t){let n=[];for(let r=0;r<e.length;r+=t)n.push(e.slice(r,r+t));return n}(t,20);Gi(Ri,1),ui(n[0])}function Ui(){Li=document.querySelector(".add-to-watched"),Ci=document.querySelector(".add-to-queue"),Ni=document.querySelector(".film-card"),Li.addEventListener("click",Mi,{once:!0}),Ci.addEventListener("click",ji),function(e){const t=JSON.parse(localStorage.getItem(e));if(null===t)return;for(let e of t)if(Ni.dataset.id===e.id)return void Fi()}(Di.watchedFilm),function(e){const t=JSON.parse(localStorage.getItem(e));if(null===t)return;for(let e of t)if(Ni.dataset.id===e.id)return void qi()}(Di.filmInQueue)}const Di={watchedFilm:"watchedFilm",filmInQueue:"filmInQueue"};function Mi(){zi(Di.watchedFilm),Fi()}function Bi(){"remove from watched"===Li.textContent&&(Hi(Di.watchedFilm),Li.style.backgroundColor="#FFF",Li.style.border="1px solid #FF6B08",Li.textContent="add to watched",Ci.disabled=!1,Ci.style.opacity=1),Li.removeEventListener("click",Bi),Li.addEventListener("click",Mi)}function ji(){zi(Di.filmInQueue),qi()}function Fi(){Li.textContent="remove from watched",Li.style.backgroundColor="#FF6B01",Li.style.border="none",Ci.disabled=!0,Ci.style.opacity=.25,Li.addEventListener("click",Bi)}function qi(){Ci.textContent="remove from queue",Ci.style.backgroundColor="#FF6B01",Ci.style.border="none",Li.style.opacity=.25,Li.disabled=!0,Ci.addEventListener("click",$i)}function $i(){"remove from queue"===Ci.textContent&&(Hi(Di.filmInQueue),Ci.style.backgroundColor="#FFF",Ci.style.border="1px solid #FF6B08",Ci.style.color="black",Ci.textContent="add to queue",Ci.disabled=!1,Li.disabled=!1,Li.style.opacity=1),Ci.removeEventListener("click",$i)}function zi(e){const t=JSON.parse(localStorage.getItem(e))||[],n={...Ni.dataset};n.genre_ids=Ni.dataset.genre.split(","),t.push(n),localStorage.setItem(e,JSON.stringify(t)),Ai()}function Hi(e){const t=function(e){return e.filter((e=>e.id!==Ni.dataset.id))}(JSON.parse(localStorage.getItem(e)));localStorage.setItem(e,JSON.stringify(t)),Ai()}const Wi=Hr.paginationList,Vi=Hr.paginationWrapper;function Gi(e,t){let n,r="",i=t-2,o=t+2;e<=1?Ki():(Vi.classList.remove("visually-hidden"),Wi.classList.remove("visually-hidden")),t>1&&(r+=`<li>\n    <button class="pagination__button" data-page="${t-1}"><</button>\n  </li>`),t>3&&(r+='<li>\n    <button class="pagination__button pagination__button--js" data-page="1">1</button>\n  </li>'),t>4&&(r+='<li class="pagination__dots">...</li>');for(let s=i;s<=o;s++)if(!(s<=0)){if(s>e)break;n=s===t?"pagination__button--current":"",r+=`<li>\n    <button class="pagination__button ${n} pagination__button--js" data-page="${s}">${s}</button>\n  </li>`}t<e-3&&(r+='<li class="pagination__dots">...</li>'),t<e-2&&(r+=`<li>\n    <button class="pagination__button pagination__button--js" data-page="${e}">${e}</button>\n  </li>`),t<e&&(r+=`<li>\n    <button class="pagination__button" data-page="${t+1}">></i></button>\n  </li>`),Wi.innerHTML=r,Wi.addEventListener("click",Ji)}async function Ji(e){const t=document.querySelector(".side-nav__link--current").dataset.id;var n;const r=null!==(n=document.querySelector(".movies-filter__button--current"))&&void 0!==n?n:"default";if(!e.target.dataset.page)return;const i=+e.target.dataset.page;if(Hr.moviesCard.innerHTML="","home"===t&&"default"===r){const e=await Zr.getSearchQuery(Zr.query,i);Gi(Zr.totalPage,i),ui(e.results)}else if("home"===t&&"popular"===r.dataset.id){const e=await Zr.getSearchQuery(Zr.query,i);Gi(Zr.totalPage,i),ui(e.results)}else if("home"===t&&"rating"===r.dataset.id){const e=await Zr.getTopRated(i);Gi(Zr.totalPage,i),ui(e.results)}else if("home"===t&&"future"===r.dataset.id){const e=await Zr.getUpcoming(i);Gi(Zr.totalPage,i),ui(e.results)}else if("library"===t){const e="watchedBtn"===document.querySelector(".library__button--active").dataset.id?Di.watchedFilm:Di.filmInQueue;if(!localStorage.getItem(e))return console.error(e);const t=JSON.parse(localStorage.getItem(e));if(Pi(t))return void Ki();Gi(Math.ceil(t.length/20),i);let n=t.slice(20*(i-1),20*i);0===n.length&&(n=t.slice(20*(i-2),20*(i-1))),ui(n)}}function Ki(){Wi.innerHTML="",Vi.classList.add("visually-hidden"),Wi.classList.add("visually-hidden")}async function Qi(){Hr.moviesCard.innerHTML="";let e=await Zr.getSearchQuery(Zr.query,Zr.page);1!==e.total_pages?(ui(e.results),Gi(Zr.totalPage,Zr.page)):Wi.innerHTML=""}!async function(){await Zr.galleryData(),Qi()}(),o("kEUo3");var Yi={};let Xi,Zi,eo;function to(e){const t=e.results;Xi=document.querySelector(".btn-trailer"),Xi.classList.add("is-hidden"),t.find((e=>{"YouTube"===e.site&&Xi.classList.remove("is-hidden")})),Xi.addEventListener("click",(()=>{!function(e){const t=e.find((e=>"YouTube"===e.site)).key,n=Yi.create(`\n    <iframe src="https://www.youtube.com/embed/${t}" width="" height="" frameborder="0" class = "trailer-size"></iframe>\n`);Zi=n.show,eo=n.close,window.addEventListener("keydown",no),Zi()}(t)}))}function no(e){"Escape"===e.code&&(window.removeEventListener("keydown",no),eo())}Yi=function e(t,n,r){function i(s,a){if(!n[s]){if(!t[s]){var u=void 0;if(!a&&u)return u(s,!0);if(o)return o(s,!0);var c=new Error("Cannot find module '"+s+"'");throw c.code="MODULE_NOT_FOUND",c}var l=n[s]={exports:{}};t[s][0].call(l.exports,(function(e){return i(t[s][1][e]||e)}),l,l.exports,e,t,n,r)}return n[s].exports}for(var o=void 0,s=0;s<r.length;s++)i(r[s]);return i}({1:[function(e,t,n){Object.defineProperty(n,"__esModule",{value:!0}),n.create=n.visible=void 0;var r=function(e){var t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=document.createElement("div");return n.innerHTML=e.trim(),!0===t?n.children:n.firstChild},i=function(e,t){var n=e.children;return 1===n.length&&n[0].tagName===t},o=function(e){return null!=(e=e||document.querySelector(".basicLightbox"))&&!0===e.ownerDocument.body.contains(e)};n.visible=o,n.create=function(e,t){var n=function(e,t){var n=r('\n\t\t<div class="basicLightbox '.concat(t.className,'">\n\t\t\t<div class="basicLightbox__placeholder" role="dialog"></div>\n\t\t</div>\n\t')),o=n.querySelector(".basicLightbox__placeholder");e.forEach((function(e){return o.appendChild(e)}));var s=i(o,"IMG"),a=i(o,"VIDEO"),u=i(o,"IFRAME");return!0===s&&n.classList.add("basicLightbox--img"),!0===a&&n.classList.add("basicLightbox--video"),!0===u&&n.classList.add("basicLightbox--iframe"),n}(e=function(e){var t="string"==typeof e,n=e instanceof HTMLElement==1;if(!1===t&&!1===n)throw new Error("Content must be a DOM element/node or string");return!0===t?Array.from(r(e,!0)):"TEMPLATE"===e.tagName?[e.content.cloneNode(!0)]:Array.from(e.children)}(e),t=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(null==(e=Object.assign({},e)).closable&&(e.closable=!0),null==e.className&&(e.className=""),null==e.onShow&&(e.onShow=function(){}),null==e.onClose&&(e.onClose=function(){}),"boolean"!=typeof e.closable)throw new Error("Property `closable` must be a boolean");if("string"!=typeof e.className)throw new Error("Property `className` must be a string");if("function"!=typeof e.onShow)throw new Error("Property `onShow` must be a function");if("function"!=typeof e.onClose)throw new Error("Property `onClose` must be a function");return e}(t)),s=function(e){return!1!==t.onClose(a)&&function(e,t){return e.classList.remove("basicLightbox--visible"),setTimeout((function(){return!1===o(e)||e.parentElement.removeChild(e),t()}),410),!0}(n,(function(){if("function"==typeof e)return e(a)}))};!0===t.closable&&n.addEventListener("click",(function(e){e.target===n&&s()}));var a={element:function(){return n},visible:function(){return o(n)},show:function(e){return!1!==t.onShow(a)&&function(e,t){return document.body.appendChild(e),setTimeout((function(){requestAnimationFrame((function(){return e.classList.add("basicLightbox--visible"),t()}))}),10),!0}(n,(function(){if("function"==typeof e)return e(a)}))},close:s};return a}},{}]},{},[1])(1);const ro={filmModal:document.querySelector(".modal-film"),closeModalFilm:document.querySelector(".modal-film-close__btn"),backdropFilmModal:document.querySelector(".js-backdrop-film-modal"),filmCardTemplate:document.querySelector(".movies-card")};function io(){window.removeEventListener("keydown",oo),document.body.classList.remove("show-modal"),ro.filmModal.innerHTML=""}function oo(e){document.querySelector(".trailer-size")||"Escape"===e.code&&io()}ro.backdropFilmModal.addEventListener("click",(function(e){e.currentTarget===e.target&&io()})),ro.filmCardTemplate.addEventListener("click",(function(){window.addEventListener("keydown",oo),event.preventDefault();const e=event.target.parentNode.parentNode.dataset.cardId;if(!e)return;document.body.classList.add("show-modal"),async function(e){await Zr.getOneMovie(e).then((e=>{const{original_title:t,id:r,title:i,poster_path:o,release_date:s,vote_average:a,vote_count:u,popularity:c,overview:l,genres:f,tags:h,videos:d}=e,p=Object.values(f);let g=[],v=[];for(const e of p)g.push(e.name),v.push(e.id);const m=`<div class="film-card"\n            data-id = '${r}'\n            data-title = '${i}'\n            data-poster_path = '${o}'\n            data-release_date="${s}"\n            data-vote_average = '${a}'\n            data-genre = '${v}'\n            >\n               <button type="button" class="modal-film-close__btn" data-action="close-modal" data-id="modalFilmCloseBtn">\n            <svg class="modal-film__vector" width="18" height="18">\n                <use href="${n(ni)}#icon-close"></use>\n            </svg>\n        </button>\n            <div class="film-info-container">\n                <div class="btn-wrapper-trailer">\n  <button type="button" class="btn-trailer" data-id="trailerBtn">\n    <div class="btn-trailer-overlay-text">\n      <h3 class="btn-trailer-text">Watch Trailer</h3>\n    </div>\n  </button>\n  <img loading="lazy"\n    class="film-poster-img"\n    src="https://image.tmdb.org/t/p/w500/${o}"\n    onError="this.onerror=null;this.src='https://subscribenow.com.au/time/asia/Solo/Content/Images/noCover.gif';"\n    alt="${h}"\n    loading="lazy"/>\n    </div>\n            <div class="value-films">\n            <h2 class="name-film">${t}</h2>\n            <table>\n            <tbody><tr><td class="info-film"">Vote / Votes</td><td class="info-value"><span class="vote">${a.toFixed(1)}\n            </span> / <span class="vote-count">${u}</span> </td></tr>\n            <tbody><tr><td class="info-film"">Popularity</td><td class="info-value">${c}</td></tr>\n            <tbody><tr><td class="info-film"">Original Title</td><td class="info-value original-title">${t}</td></tr>\n            <tbody><tr><td class="info-film"">Genre</td><td class="info-value genres-film">${g.join(", ")}</td></tr>\n                </table>\n            <h3 class="about-film-title">about</h3>\n            <p><span class="about-film-text">${l}</span></p>\n            <div class="modal-btn-wrapper">\n            <button type="button" class="film-modal-btn add-to-watched">add to watched</button>\n            <button type="button" class="film-modal-btn add-to-queue">add to queue</button>\n            </div>\n            </div>\n            </div>\n            </div>`;ro.filmModal.innerHTML=m,ro.closeModalFilm=document.querySelector(".modal-film-close__btn"),ro.closeModalFilm.addEventListener("click",io),Ui(),to(d)}))}(+e)}));const so={openModalBtn:document.querySelector("[data-modal-open]"),closeModalBtn:null,modal:document.querySelector("[data-modal]"),modalContent:document.querySelector(".team-modal-wrapper"),list:document.querySelector(".team-modal__list"),front:document.querySelector(".wrap-front"),back:document.querySelector(".wrap-back")};so.modal.addEventListener("click",(function(e){e.currentTarget===e.target&&co()})),so.openModalBtn.addEventListener("click",(function(){window.addEventListener("keydown",lo),so.closeModalBtn.removeAttribute("disabled"),so.modalContent.style.opacity=1;let e=250;uo(),ao.forEach((t=>{e+=250,setTimeout((()=>{t.firstElementChild.style.transform="rotateY(360deg)",t.lastElementChild.style.transform="rotateY(180deg)"}),e)}))})),so.closeModalBtn=document.querySelector("[data-modal-close]"),so.closeModalBtn.addEventListener("click",co);const ao=[...so.list.children];function uo(){so.modal.classList.toggle("visually-hidden")}function co(){window.removeEventListener("keydown",lo),so.closeModalBtn.setAttribute("disabled","disabled"),so.modalContent.style.opacity=1;let e=150;setTimeout(uo,2e3),ao.forEach((t=>{e+=150,setTimeout((()=>{so.modalContent.style.opacity-=.05,t.firstElementChild.style.transform="rotateY(180deg)",t.lastElementChild.style.transform="rotateY(360deg)"}),e)}))}function lo(e){"Escape"===e.code&&co()}var fo;fo=new URL(o("kyEFX").resolve("43rp0"),import.meta.url).toString();var ho;ho=new URL(o("kyEFX").resolve("kO8nb"),import.meta.url).toString();const po=document.querySelector("body"),go=document.querySelector("footer"),vo=document.querySelector('[data-id ="global-page-style"]'),mo={dark:0,light:1,changeToDark(){this.dark=1,this.light=0},changeToLight(){this.light=1,this.dark=0}};document.querySelector(".darktheme-btn").addEventListener("click",(function(){0===mo.dark&&(yo(),setTimeout((()=>{mo.changeToDark()}),100));0===mo.light&&(_o(),setTimeout((()=>{mo.changeToLight()}),100))}));const yo=function(){const e=document.querySelector(".darktheme-icon__moon");document.querySelector(".darktheme-icon__sun").style.opacity=1,e.style.opacity=0,po.style.backgroundColor="rgb(17, 17, 17)",go.style.backgroundColor="black",""!==localStorage.getItem("THEME")&&"LIGHT"!==localStorage.getItem("THEME")||localStorage.setItem("THEME","DARK"),vo.innerHTML=`.movies-card__heading { transition: color; transition-duration: 500ms; color: white;}.content { transition: color; transition-duration: 500ms; color: #ff6b08;}.team-modal { transition: color; transition-duration: 500ms; color: #ff6b08;}.pagination { transition: background-color; transition-duration: 500ms; background-color: rgb(17, 17, 17);}.modal-film { background-color: black;}.name-film { color: white;}.info-value { color: #ff6b08;}.about-film-title { color: #ff6b08;}.about-film-text { color: #ff6b08;}.film-modal-btn {background-color: #ff6b08; }.content__title {color: black; }.modal-film-close__btn {fill: white;}.pagination__button {color:white;}.pagination__dots {color:white;}.background__main {background-image: url("${fo}"); background-position: center;\n        background-repeat: repeat-y;\n        background-size: contain;\n        background-attachment: scroll, scroll;\n        background-origin: padding-box, padding-box;\n        background-clip: border-box, border-box;}.background__main--lib {background-image: url("${ho}"); background-position: center;\n        background-repeat: no-repeat;\n        background-attachment: scroll, scroll;\n        background-origin: padding-box, padding-box;\n        background-clip: border-box, border-box; }.movies-filter__button {color:white; background-color:black;}.modal-film-close__btn {fill: white;}`},_o=function(){const e=document.querySelector(".darktheme-icon__moon"),t=document.querySelector(".darktheme-icon__sun");po.style.backgroundColor="white",go.style.backgroundColor="#f7f7f7",t.style.opacity=0,e.style.opacity=1,localStorage.setItem("THEME","LIGHT"),vo.innerHTML=""};"DARK"===localStorage.getItem("THEME")&&(yo(),mo.changeToDark());var bo=o("kEUo3");const wo=document.querySelector(".scrolltop__btn");window.addEventListener("scroll",(0,bo.throttle)((function(){window.scrollY>200&&(wo.classList.add("transitionBtn"),wo.classList.remove("is-hidden-button"),wo.classList.add("animate__animated"),wo.classList.add("animate__bounce"));window.scrollY<200&&(wo.classList.add("is-hidden-button"),wo.classList.remove("animate__animated"),wo.classList.remove("animate__bounce"))}),200)),wo.addEventListener("click",(function(e){e.preventDefault(),window.scrollTo(0,0)}));
//# sourceMappingURL=index.1d0ebc20.js.map
